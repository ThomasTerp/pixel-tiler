...
export default abstract class PaletteColor extends React.Component<IProps, IState>
{
	...
	{
		return (
			<div className={`PaletteColor ${conditionalClass("Selectable", this.props.isSelectable)} ${conditionalClass("Editable", this.props.isEditable)} ${conditionalClass("Active", this.isSelected())}`}>
